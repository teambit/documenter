...
export const examples = [
  {
    ...
    description: (
      <>
        <p>
          The Prop Table renders an array of objects. The objects' shape and the
          corresponding table headers are not customizable.
        </p>{' '}
        <br />
        <p>
          Manually populating the Prop Table is discouraged as it should only
          use the component's code as a source of truth (this ensures the data
